...
import { CheckpointRef } from "@t3sparks/contracts";
        ...
        (tempDir) =>
          Effect.gen(function* () {
            ...
            const commitEnv: NodeJS.ProcessEnv = {
              ...
              GIT_AUTHOR_NAME: "T3 Sparks",
              GIT_AUTHOR_EMAIL: "t3sparks@users.noreply.github.com",
              GIT_COMMITTER_NAME: "T3 Sparks",
              GIT_COMMITTER_EMAIL: "t3sparks@users.noreply.github.com",
            };
