...
const runCli = (
  ...
  env: Record<string, string> = { T3SPARKS_NO_BROWSER: "true" },
) => {
    ...
    Effect.provide(
      ConfigProvider.layer(
        ConfigProvider.fromEnv({
          env: {
            T3SPARKS_STATE_DIR: uniqueStateDir,
            ...env,
          },
        }),
      ),
...
it.layer(testLayer)("server CLI command", (it) => {
  ...
  it.effect("uses env fallbacks when flags are not provided", () =>
    Effect.gen(function* () {
      yield* runCli([], {
        T3SPARKS_MODE: "desktop",
        T3SPARKS_PORT: "4999",
        T3SPARKS_HOST: "100.88.10.4",
        T3SPARKS_STATE_DIR: "/tmp/t3-env-state",
        VITE_DEV_SERVER_URL: "http://localhost:5173",
        T3SPARKS_NO_BROWSER: "true",
        T3SPARKS_AUTH_TOKEN: "env-token",
      });
  ...
  it.effect("prefers --mode over T3SPARKS_MODE", () =>
    Effect.gen(function* () {
  ...
  it.effect("prefers --no-browser over T3SPARKS_NO_BROWSER", () =>
    Effect.gen(function* () {
      yield* runCli(["--no-browser"], {
        T3SPARKS_NO_BROWSER: "false",
      });
  ...
  it.effect("supports CLI and env for bootstrap/log websocket toggles", () =>
    Effect.gen(function* () {
      yield* runCli(["--auto-bootstrap-project-from-cwd"], {
        T3SPARKS_MODE: "desktop",
        T3SPARKS_LOG_WS_EVENTS: "false",
        T3SPARKS_AUTO_BOOTSTRAP_PROJECT_FROM_CWD: "false",
        T3SPARKS_NO_BROWSER: "true",
      });
