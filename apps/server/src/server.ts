...
import { GithubCopilotAdapterLive } from "./provider/Layers/GithubCopilotAdapter.ts";
...
const ProviderLayerLive = Layer.unwrap(
  Effect.gen(function* () {
    ...
    const githubCopilotAdapterLayer = GithubCopilotAdapterLive;
