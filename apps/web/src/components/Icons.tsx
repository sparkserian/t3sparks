...
export const GitHubCopilot: Icon = (props) => (
  <svg {...props} viewBox="0 0 98 96" fill="currentColor">
    <path d="M48.9 0C21.9 0 0 21.5 0 48c0 21.2 14 39.2 33.4 45.6 2.4.5 3.3-1 3.3-2.4v-8.4c-13.6 2.9-16.5-5.7-16.5-5.7-2.2-5.5-5.4-7-5.4-7-4.4-3 .3-2.9.3-2.9 4.9.3 7.5 4.9 7.5 4.9 4.3 7.2 11.4 5.1 14.2 3.9.4-3 1.7-5.1 3-6.3-10.9-1.2-22.4-5.3-22.4-23.8 0-5.3 1.9-9.7 5-13.1-.5-1.2-2.2-6.1.5-12.7 0 0 4.1-1.3 13.4 5 3.9-1.1 8-1.6 12.1-1.6s8.2.5 12.1 1.6c9.2-6.3 13.3-5 13.3-5 2.7 6.6 1 11.5.5 12.7 3.1 3.4 5 7.8 5 13.1 0 18.5-11.5 22.6-22.5 23.8 1.8 1.5 3.3 4.5 3.3 9v13.3c0 1.3.9 2.9 3.4 2.4C84 87.2 98 69.2 98 48 98 21.5 76.1 0 48.9 0Z" />
  </svg>
);
