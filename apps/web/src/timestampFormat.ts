import { type AppTimestampFormat } from "./appSettings";

function getTimestampFormatOptions(
  timestampFormat: AppTimestampFormat,
...
export function formatTimestamp(isoDate: string, timestampFormat: AppTimestampFormat): string {
  return getTimestampFormatter(timestampFormat, true).format(new Date(isoDate));
}

export function formatShortTimestamp(isoDate: string, timestampFormat: AppTimestampFormat): string {
